		...
		<div class="collapse navbar-collapse justify-content-end">
			<ul class="navbar-nav">
				<li class="nav-item active">
					<a style="font-size: 20px; font-weight: bold; cursor: pointer;" class="nav-link" href="top" >TOP</a>
				</li>
				<li class="nav-item active">
	...
	<div id="insertUserConfirm">
		...
		<form action="userInsertConfirm" method="post">
			<fieldset id="insertUserConfirm_form">
				<div>
					<label>ID　：</label>
					<input type="text" name="loginId" value="${fn:escapeXml(sessionInfo.registerUser.loginId)}" readonly>
				</div>
				<div>
					<label>名前：</label>
					<input type="text" name="userName" value="${fn:escapeXml(sessionInfo.registerUser.userName)}" readonly>
				</div>
				<div>
					<label>年代：</label>
					<input type="text" name="ageName" value="${fn:escapeXml(sessionInfo.registerUser.ageStr)}" readonly>
				</div>
				<div>
